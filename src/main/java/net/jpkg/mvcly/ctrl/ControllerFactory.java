...
/**
 * This is a lightweight (cheap) dependency injector, it takes the keys and values from
 * {@code baseDependencies} and execute the {@code set{Key} } method of the controller if is
 * available with the corresponding value.
 * <p>
 * Additional dependencies are injected when calling the {@code getController} method, receiving a
 * pair or pairs of key and values.
 * <p>
 * For example, if {@code baseDependencies} contains a key "dataSource" with an Object
 * {@code DataSource} the method {@code setDataSource} will be executed in each controller, setting
 * the same Object instance.
 * <p>
 * This class doesn't check types, a {@code RuntimeException} can be produced if the
 * {@code set{Key} } method expects a different type.
 * <p>
...
public class ControllerFactory {
  ...
  public BaseController getController(Class<? extends BaseController> clazz, String field,
      Object value)
      throws Exception {
    return getController(clazz, Map.of(field, value));
  }

  public BaseController getController(Class<? extends BaseController> clazz, String field1,
      Object value1,
  ...
  public BaseController getController(Class<? extends BaseController> clazz,
      Map<String, Object> otherDependencies)
      throws Exception {
